 ...
 * under the License.
 */
package ws.michalski.sepa.pain.interfaces;
...
public interface SEPAReader {

	public abstract SEPAMessage parse(InputStream is)
			throws SEPAException, SEPASchemaException;
