...
public class SEPAReaderPain_008_002_02 implements SEPAReader {
	...
	public SEPAReaderPain_008_002_02(){
		super();
		log = LogFactory.getLog(SEPAReaderPain_008_002_02.class);
	}
	...
	public SEPAMessage parse(InputStream is) throws SEPAException {
		...
		try {
			...
			for (PaymentInstructionInformationSDD payment : debList) {
				...
				// Typ wählen
				LocalInstrumentSEPACode typ = payment.getPmtTpInf().getLclInstrm().getCd();
				switch (typ) {
				case CORE:
