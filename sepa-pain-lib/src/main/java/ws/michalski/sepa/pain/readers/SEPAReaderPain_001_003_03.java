...
public class SEPAReaderPain_001_003_03 implements SEPAReader {

	Document doc;
	private Log log;


	public SEPAReaderPain_001_003_03(){
		super();
		log = LogFactory.getLog(SEPAReaderPain_001_003_03.class);
	}
	...
	public SEPAMessage parse(InputStream is) throws SEPAException {
		...
		try {
			...
			for (PaymentInstructionInformationSCT payment : crdList) {
				...
				// Taggleiche Eilüberweisungen ab pain.001.003.03
				ct.setUrgendServLev(payment.getPmtTpInf().getSvcLvl().getCd().equalsIgnoreCase("URGP"));
